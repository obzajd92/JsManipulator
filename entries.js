...
/* Dracula Pink*/rect.setAttribute("rx", "4");svg.appendChild(rect);/* 3. Append quantity metrics values*/const textCount = document.createElementNS(svgNamespace, "text");textCount.setAttribute("x", 135 + computedBarWidth + 8);textCount.setAttribute("y", yPosition + 22);textCount.setAttribute("fill", "#50fa7b"); /* Dracula Green*/textCount.style.fontFamily = "sans-serif";textCount.style.fontSize = "12px";textCount.style.fontWeight = "bold";textCount.textContent = (${count});svg.appendChild(textCount);});
